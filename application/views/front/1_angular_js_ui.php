...
<head>
    <title>MEC 2105 <?php if(isset($title)){
        echo " | ".$title; 
        } ?></title>
		<meta charset="utf-8">
		...
		<link href="<?php echo base_url();?>css/font-awesome.min.css" rel="stylesheet">
                ...
                <script src="<?php echo base_url();?>mec_scripts/utility_scripts/jsval.js"></script>
	</head>
	<body>
					...
					<div class="container">
						<div class="row clearfix">
							<div class="col-lg-4 col-md-4 col-sm-5 t_xs_align_c">
                                                            ...
                                                            if($customer_id != NULL){
                                                            ?>
                                                            <p class="f_size_small">Welcome, <?php echo $this->session->userdata("customer_name") ?> can you <a href="<?php echo base_url(); ?>customer_controller/customer_logout" data-popup="#login_popup">Log Out</a></p>
                                                            <?php } else { ?>    
                                                            <p class="f_size_small">Welcome visitor can you	<a href="#" data-popup="#login_popup">Log In</a> or <a href="<?php echo base_url();?>cart_controller">Create an Account</a> </p>
                                                            <?php } ?>    
							</div>
							...
							<ul class="d_inline_b horizontal_list clearfix t_align_l site_settings">
								...
								<li class="m_left_5 relative container3d" id="shopping_button">
										...
										<span class="d_inline_middle shop_icon m_mxs_right_0">
											...
											<span class="count tr_delay_hover type_2 circle t_align_c"><?php $this->cart->total_items(); ?></span>
										</span>
											...
											<li>
												<div class="clearfix">
													...
													<div class="f_left product_description">
														...
														<span class="f_size_medium"><?php echo $content_value['name'] ?></span>
													</div>
													<!--product price-->
													<div class="f_left f_size_medium">
														<div class="clearfix">
															<?php echo $content_value['qty']; ?> x <b class="color_dark"><?php echo $content_value['price']; ?></b>
														</div>
                                                                                                            <a href="<?php echo base_url()."cart_controller/remove_from_cart_front/".$content_value['rowid']; ?>" class="close_product color_dark tr_hover"><i class="fa fa-times"></i></a>
													</div>
												</div>
											</li>
                                                                                    <?php } ?>
					...
					<div class="container clearfix">
						...
						<nav role="navigation" class="f_left f_xs_none d_xs_none">	
							<ul class="horizontal_list main_menu clearfix">
                                                            <li class="current relative f_xs_none m_xs_bottom_5"><a href="<?php echo base_url(); ?>front_controller/home.aspx" class="tr_delay_hover color_light tt_uppercase"><b>Home</b></a>
									<!--sub menu-->
									<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
										<ul class="sub_menu">
											...
											<li><a class="color_dark tr_delay_hover" href="<?php echo base_url();?>front_controller/home.aspx">Ajax</a></li>
                                                                ...
                                                                <!-- angular js codes -->
                                                                <li class="relative f_xs_none m_xs_bottom_5"><a href="<?php echo base_url(); ?>" class="tr_delay_hover color_light tt_uppercase"><b>Sliders</b></a>
									<!--sub menu-->
									<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
										<ul class="sub_menu">
                                                                                    <li ng-repeat="ct in products | orderBy:'category_name' | unique:'category_name'">
                                                                                        <a class="color_dark tr_delay_hover" ng-href="#top_product_container" ng-click="select_category(ct)">{{ct}}</a>
                                                                                        </li>
										</ul>
									</div>
								</li>
									...
									<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
										<ul class="sub_menu">
                                                                                    <li ng-repeat="mn in products | orderBy : 'manufacturer_name' | unique : 'manufacturer_name'">
                                                                                        <a class="color_dark tr_delay_hover" ng-href="#top_product_container" ng-click="select_manufacturer(mn)">{{mn}}</a>
                                                                                        </li>
										</ul>
									</div>
								</li>
				...
				<div class="container">
					...
					<!--products-->
                                        ...
                                        <section class="fill_style">
                                            <div class="container">
                                                <div class="panel panel-default" ng-if="((products | filter:is_product_selected).length > 0)">
                                                    <div id='topheader' class="panel-heading">
                                                        <div class="col-lg-6">
                                                            <h3 id="header_ajs" class="fa fa-2x">Angular Js</h3>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <h4 id='header_count'>
                                                                <i class="icon-th">{{message}}</i>
                                                                <span class="label label-primary">{{(products | filter:is_product_selected).length}}</span>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                    <div id="select_div" class="panel-body">
                                                        <strong>Select Products Per Page :-</strong>
                                                        <select class="dropdown" ng-model="page_size"
                                                                ng-options="num for num in limit_range"
                                                                ng-change="reset_page()"></select>
                                                    </div>
                                                    <div id="product_container" class="panel-body">
                                                        <!-- product item -->
                                                        <div class="product_div" ng-repeat="pr in products | filter:is_product_selected | orderBy:'-product_id' | range:selected_page:page_size">
                                                            <figure class="figure_style">
                                                                <a class="fill_style" ng-href="<?php echo base_url();?>front_controller/details_product{{pr.product_id}}">
                                                                    <img class="img_style" ng-src="{{pr.upload_path + pr.product_image}}" />
                                                                </a>
                                                                <figcaption class="caption_style"><strong>{{pr.product_name}}</strong></figcaption>
                                                                <span class="caption_style">prics : <strong id="price_strong">{{pr.product_price | currency}} &nbsp;</strong></span>
                                                            </figure>
                                                            <div class="fill_style">
                                                                <div class="btn-group">
                                                                    <a ng-href="<?php echo base_url();?>front_controller/details_product/{{pr.product_id}}" class="btn btn-primary btn-default">Details</a>
                                                                </div>
                                                            </div>
                                                            <hr class="fill_style"/>
                                                        </div>
                                                ...
                                                <div ng-if="((products | filter:is_product_selected).length == 0)" class="error_message">
                                                    No Product to show ......
                                                </div>
                                            </div>
                                        </section>
			  ...
			  <h3 class="m_bottom_20 color_dark">Log In</h3>
					...
					<ul>
						<li class="m_bottom_15">
							...
							<input type="text" name="" id="login_email" name="login_emai" regexp="JSVAL_RX_EMAIL" 
                                                               err="Please Enter Valid Email Address ....." maxlength="100"
                                                               required="required" placeholder="email.address@example.com" class="r_corners full_width">
						</li>
		...
		<script src="<?php echo base_url();?>js/scripts.js"></script>
                ...
                <script type="text/javascript" src="<?php echo base_url();?>bower_components/angular-i18n/angular-locale_bn-bd.js"></script>
                <script type="text/javascript" src="<?php echo base_url();?>mec_scripts/modules/mec_2105_app.js"></script>
                <script type="text/javascript">
                    
                    mec_2105_app.factory('products_service', ['$http', function ($http){
                            var products_service = {};
                            products_service.get_products = function() {
                                return $http.get('<?php echo base_url(); ?>front_controller/products_json.aspx');
                            }
                ...
                <script type="text/javascript" src="<?php echo base_url();?>mec_scripts/controllers/products_controller.js"></script>
                </div>
            </div>
	</body>
