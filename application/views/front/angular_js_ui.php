	...
	<body>
		...
		<div class="boxed_layout relative w_xs_auto">
													...
													<div class="f_left f_size_medium">
														<div class="clearfix">
															<?php echo $content_value['qty'];?> x <b class="color_dark"><?php echo $content_value['price'];?> BDT</b>
                                                                                                            ...
                                                                                                            <a href="<?php echo base_url()."cart_controller/remove_from_cart_front/".$content_value['rowid']; ?>" 
							...
							<ul class="horizontal_list main_menu clearfix">
								<li class="current relative f_xs_none m_xs_bottom_5"><a href="<?php echo base_url(); ?>" class="tr_delay_hover color_light tt_uppercase"><b>Home</b></a>
									...
									<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
										<ul class="sub_menu">
                                                                                    <li><a class="color_dark tr_delay_hover" href="<?php echo base_url();?>">Ajax</a></li>
											<li><a class="color_dark tr_delay_hover" href="<?php echo base_url();?>front_controller/home.aspx">Angular JS</a></li>
										</ul>
									</div>
								</li>
                                                                <!--angular js codes-->
								<li class="relative f_xs_none m_xs_bottom_5"><a href="<?php echo base_url();?>" class="tr_delay_hover color_light tt_uppercase"><b>Categories</b></a>
									<!--sub menu-->
									<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
										<ul class="sub_menu">
								...
								<li class="relative f_xs_none m_xs_bottom_5"><a href="<?php echo base_url();?>" class="tr_delay_hover color_light tt_uppercase"><b>Manufacturers</b></a>
									<!--sub menu-->
									<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
										<ul class="sub_menu">
			...
			<div class="page_content_offset">
				<div class="container">
                                    <h3 id="header_category_manufacturer" class="tt_uppercase m_bottom_20 color_dark heading1 animate_ftr">Category : {{category}} | Manufacturer : {{manufacturer}}</h3>
					<!--filter navigation of products-->
					<ul class="horizontal_list clearfix tt_uppercase isotope_menu f_size_ex_large">
                                            <li class="active m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><a href="" class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="*">All</a></li>
                                            <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr">
                                                <a href="<?php echo base_url(); ?>front_controller/best_seller.aspx" class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".featured">Best Sellers</a>
                                            </li>
                                            ...
                                            <div class="container">
                                                <div class="panel panel-default" ng-if="((products | filter:is_product_selected).length > 0)">
                                                    <div id="topheader" class="panel-heading">
                                                        <div class="col-lg-6">
                                                            <h3 id="header_ajs" class="fa fa-2x">AngularJs</h3>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <h4 id="header_count">
                                                        ...
                                                        <div class="product_div" ng-repeat="pr in products | filter:is_product_selected | orderBy:'-product_id' | range:selected_page:page_size">
                                                            <figure class="figure_style">
                                                                <a class="fill_style" ng-href="<?php echo base_url(); ?>front_controller/details_product/{{pr.product_id}}">
                                                                    <img class="img_style" ng-src="<?php echo base_url();?>{{pr.upload_path + pr.product_image}}" />
                                                                </a>
                                                                <figcaption class="caption_style"><strong>{{pr.product_name}}</strong></figcaption>
                                                                <span class="caption_style">price : <strong id="price_strong">{{pr.product_price|currency}} &nbsp;</strong></span>
                                                            </figure>
                                                            <div class="fill_style">
                                                                <div class="btn-group">
                                                                    <a ng-href="<?php echo base_url(); ?>front_controller/details_product/{{pr.product_id}}" class="btn btn-primary btn-default">Deatails</a>
