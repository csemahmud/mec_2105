...
<h3 id="header_category_manufacturer" class="tt_uppercase m_bottom_20 color_dark heading1 animate_ftr">All Products</h3>
<!--filter navigation of products-->
<ul class="horizontal_list clearfix tt_uppercase isotope_menu f_size_ex_large">
        <li class="active m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><a class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="*">All</a></li>
        ...
        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><a class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".new">New</a></li>
        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><a class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".specials">Specials</a></li>
        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><a class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".hit">Hit</a></li>
        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><a class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".random">Random</a></li>
        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><a class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter=".rated">Rated</a></li>
</ul>
...
<section class="fill_style">
    <div class="container">
        ...
        <div id="ajax_product_home">
            <h3>
                Select Category or Manufacturer
            </h3>
        </div>
