...
<div class="panel panel-default">
    <div id='topheader' class="panel-heading">
        ...
        <div class="col-lg-6">
            <h4 id='header_count'>
                <i class="icon-th">Total Products : </i>
    ...
    <div id="product_container" class="panel-body">
        ...
        <div class="product_div">
            ...
            <div class="fill_style">
                <div class="btn-group">
                    <a href="<?php echo base_url();?>front_controller/details_product/<?php echo $v_product->product_id; ?>" class="btn btn-primary btn-default">Details</a>
                </div>
            </div>
            <hr class="fill_style"/>
        </div>
...
<?php } else { ?>
<div>
    <h1 class="error_message">No Product to show ......</h1>
</div>
<?php } ?>