                          ...
                          <fieldset>
                              ...
                              <?php } ?>
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <textarea class="cleditor" id="product_short_description" name="product_short_description" 
                                                rows="3" tabindex="4"><?php
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <textarea class="cleditor" id="product_long_description" name="product_long_description" 
                                                rows="3" tabindex="5"><?php
                              ...
                              <?php 
                                ...
                                ?>
                              <div class="control-group">
                                  <label class="control-label" for="current_image">Current Image</label>
                                      <div class="controls">
                                          <figure class="figure_style" id="current_image">
                                              <img class="img_style" id="current_product_image" src="<?php
                                                echo base_url().$product_info->upload_path.$product_info->product_image;
                                              ?>"/>
                                          </figure>
                                      </div>
                                </div>
                              ...
                              ?>
                                ...
                                <div class="control-group">
                                  <label class="control-label" for="product_image">Select Product Image :</label>
                                  <div class="controls">
                              ...
                              ?>">
                                ...
                                <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <label class="radio">
                                              <input type="radio" name="pr_publication_status" id="pr_publication_status" value="1" 
                                                     <?php
                                                        if(isset($product_info->publication_status)){
