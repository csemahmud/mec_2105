...
<body>
	...
	<!-- topbar ends -->
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading">
                                                            <a class="accordion-toggle btn ajax-link" data-toggle="collapse" data-parent="#questions"
                                                               href="#category_links"><i class="icon-list"></i><span class="hidden-tablet">  Category  </span></a>


                                                        </div>
                                                        <div id="category_links" class="accordion-body collapse">
						...
						<li>
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading">
                                                            <a class="accordion-toggle btn ajax-link" data-toggle="collapse" data-parent="#questions"
                                                               href="#manufacturer_links"><i class="icon-list"></i><span class="hidden-tablet">  Manufacturer  </span></a>


                                                        </div>
                                                        <div id="manufacturer_links" class="accordion-body collapse">
                                                            <div class="accordion-inner">
                                                                <ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading">
                                                            <a class="accordion-toggle btn ajax-link" data-toggle="collapse" data-parent="#questions"
                                                               href="#product_links"><i class="icon-list"></i><span class="hidden-tablet">  Product  </span></a>


                                                        </div>
                                                        <div id="product_links" class="accordion-body collapse">
                                                            <div class="accordion-inner">
                                                                <ul class="nav nav-tabs nav-stacked main-menu">
                                                                   <li><a class="ajax-link" href="<?php echo base_url();?>product_controller/add_product.aspx"><i class="icon-plus"></i><span class="hidden-tablet">Add Product</span></a></li>
                                                                    ...
                                                                    <li><a class="ajax-link" href="chart.html"><i class="icon-edit"></i><span class="hidden-tablet">AngularJs Products</span></a></li>
                                                                </ul>
                                                            </div>
						...
						<li>
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading">
                                                            <a class="accordion-toggle btn ajax-link" data-toggle="collapse" data-parent="#questions"
                                                               href="#order_links"><i class="icon-list"></i><span class="hidden-tablet">  Order  </span></a>


                                                        </div>
                                                        <div id="order_links" class="accordion-body collapse">
                                                            <div class="accordion-inner">
                                                                <ul class="nav nav-tabs nav-stacked main-menu">
                                                                    <li><a class="ajax-link" href="typography.html"><i class="icon-edit"></i><span class="hidden-tablet">Manage Orders</span></a></li>
                                                                </ul>
                                                            </div>
						...
						<li><a class="ajax-link" href="gallery.html"><i class="icon-bookmark"></i><span class="hidden-tablet">Welcome Message</span></a></li>
					</ul>
		...
		<footer>
			<p class="pull-left">&copy; <a href="http://usman.it" target="_blank">Mahmudul Hasan Khan CSE</a> 2021</p>
			<p class="pull-right">Powered by: <a href="http://usman.it/free-responsive-admin-template">mec_2105</a></p>
		</footer>
	...
	<script src="<?php echo base_url();?>js/charisma.js"></script>
                ...
                <script type="text/javascript">
                    ...
                    mec_2105_app.factory('all_products_service', ['$http', function ($http){
                            var all_products_service = {};
                            all_products_service.get_all_products = function() {
                                return $http.get('<?php echo base_url(); ?>front_controller/all_products_json.aspx');
                            }
