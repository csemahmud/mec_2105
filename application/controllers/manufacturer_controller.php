...
class Manufacturer_Controller extends CI_Controller {
    ...
    function check_manufacturer_name($manufacturer_name) {
        echo count($this->manufacturer_model->select_manufacturers_by_name($manufacturer_name));
    }
    
    function check_name_considering_id($manufacturer_id, $manufacturer_name) {
        echo count($this->manufacturer_model->select_manufacturers_by_name_except_id($manufacturer_id, $manufacturer_name));
    }
}
