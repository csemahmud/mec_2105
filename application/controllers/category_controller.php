...
class Category_Controller extends CI_Controller {
    ...
    function check_name_considering_id($category_id, $category_name) {
        echo count($this->category_model->select_categories_by_name_except_id($category_id, $category_name));
    }
}
